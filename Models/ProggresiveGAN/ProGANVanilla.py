...
"""
# TODO: determine why generator has following ends (4,4)->(4,4):
"""
ProGAN.Generator._fadein_model.inputs
Out[3]: [<tf.Tensor 'input_2:0' shape=(None, 4, 4, 3) dtype=float32>]
ProGAN.Generator._fadein_model.outputs
Out[4]: [<tf.Tensor 'conv2d_5/Identity:0' shape=(None, 4, 4, 3) dtype=float32>]

***NOTE AFTER grow() CALL ***
ProGAN.grow()
ProGAN.Generator._fadein_model.outputs
Out[6]: [<tf.Tensor 'weighted_sum_1/Identity:0' shape=(None, 8, 8, 3) dtype=float32>]
ProGAN.Generator._fadein_model.inputs
Out[7]: [<tf.Tensor 'input_2:0' shape=(None, 4, 4, 3) dtype=float32>]

error occurs both with and without grow phase prior to feed through
"""
